...
urlpatterns = [
    ...
    path("solutiondetail/<str:slug>",
         views.OurSolutionsDetailView.as_view(), name='oursolution_detail'),
    path("serviceslist", views.OurServicesListView.as_view(),
         name='ourservices_list'),
    path("servicedetail/<str:slug>",
         views.OurServicesDetailView.as_view(), name='ourservice_detail'),
    path("productslist", views.OurProductsListView.as_view(),
         name='ourproducts_list'),
    path("productdetail/<str:slug>",
         views.OurProductsDetailView.as_view(), name='ourproduct_detail'),
]
